...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Status status, ChannelModel? selectedChannel, bool isPlaying});
...
class _$HomeStateImpl implements _HomeState {
  ...
  @override
  String toString() {
    return 'HomeState(status: $status, selectedChannel: $selectedChannel, isPlaying: $isPlaying)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, status, selectedChannel, isPlaying);
...
abstract class _HomeState implements HomeState {
  const factory _HomeState(
      {final Status status,
      final ChannelModel? selectedChannel,
      final bool isPlaying}) = _$HomeStateImpl;
